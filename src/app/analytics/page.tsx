    ...
    <AdminLayout adminName={adminName}>
      ...
      {loading ? <Panel title="Loading…"><Empty msg="Crunching the numbers…" /></Panel> : (
        <div id="qmg-analytics-print">
          ...
          {tab === 'AI Insights' && (
            <Panel title="AI Business Insights" right={<span style={{ display: 'inline-flex', alignItems: 'center', gap: 5, fontSize: 11, color: GOLD, fontWeight: 700 }}><Sparkles size={13} /> Auto-generated</span>}>
              {insights.length === 0 ? <Empty msg="Not enough data to generate insights yet." /> : (
                <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                  {insights.map((ins, i) => {
