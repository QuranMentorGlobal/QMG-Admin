// ============================================================
// PASTE THIS WHOLE FILE INTO:  src/middleware.ts   (NOT repo root — with a src/
// app dir, Next.js 14 only loads middleware from src/middleware.ts. A root-level
// middleware.ts is silently ignored, which disables auth/2FA/permission gating.)
